...
# 所有找到的DOI
items = {
    'AP5TY6EZ': '10.1109/TMTT.2025.3622376',
    'MUMQN6SX': '10.1109/TMTT.2025.3631548',
    '7EFI8EVS': '10.1109/TMTT.2025.3619198',
    'IJ4KZ659': '10.1109/TMTT.2024.3514691',
    'DS6NYVZL': '10.1109/LMWT.2025.3559761',
    'YZXXYDZ7': '10.1109/TMTT.2025.3622632',
    'K4XI6JM2': '10.1109/TMTT.2025.3625545'
}
...
print(f"\nAll DOI extraction and update completed!")
print(f"Total processed: {40 + success_count} out of 53")
print(f"Remaining: {53 - (40 + success_count)}")
